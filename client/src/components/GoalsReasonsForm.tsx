...
const TIMELINE_OPTIONS = ["< 1 Year", "1-3 Years", "3-5 Years", "5-10 Years", "10+ Years"]
...
export function ImprovedGoalsReasonsForm({ data, update }: ImprovedGoalsReasonsFormProps) {
  ...
  const addGoal = () => {
    setValue("financialGoals", [...financialGoals, { goal: "", timeline: "", targetAmount: "", priority: "" }])
  }
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-teal-700 dark:text-teal-300">Income & Expenses</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <Label htmlFor="monthly_income" className="text-base block mb-2">
                    Monthly Income (₹)
                  </Label>
                  <Input
                    id="monthly_income"
                ...
                <div className="space-y-3">
                  <Label htmlFor="annual_income" className="text-base block mb-2">
                    Annual Income (₹)
                  </Label>
                  <Input
                    id="annual_income"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <Label htmlFor="monthly_expenses" className="text-base block mb-2">
                    Monthly Expenses (₹)
                  </Label>
                  <Input
                    id="monthly_expenses"
                ...
                <div className="space-y-3">
                  <Label htmlFor="investment_capacity" className="text-base block mb-2">
                  ...
                  <Input
                    ...
                    type="number"
                    min={0}
                    {...register("investment_capacity", { valueAsNumber: true })}
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  />
                  {errors.investment_capacity && <p className="text-red-500 text-sm mt-1">{errors.investment_capacity.message}</p>}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-teal-700 dark:text-teal-300">Emergency Fund & Loans</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <Label htmlFor="emergency_fund" className="text-base block mb-2">
                  ...
                  <Input
                    ...
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  />
                  {errors.emergency_fund && <p className="text-red-500 text-sm mt-1">{errors.emergency_fund.message}</p>}
                </div>
                
                <div className="space-y-3">
                  <Label htmlFor="emergency_fund_months" className="text-base block mb-2">
                    <FinancialTermTooltip term="emergency_fund_months">Emergency Fund (Months)</FinancialTermTooltip>
                  </Label>
                  <Input
                    ...
                    min={0}
                    step={0.1}
                    {...register("emergency_fund_months", { valueAsNumber: true })}
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  />
                  {errors.emergency_fund_months && <p className="text-red-500 text-sm mt-1">{errors.emergency_fund_months.message}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setValue("existing_loans", checked === true)}
                ...
                <div className="space-y-3">
                  <Label htmlFor="debt_to_income" className="text-base block mb-2">
                    <FinancialTermTooltip term="debt_to_income">Debt to Income Ratio</FinancialTermTooltip>
                    <span className="text-sm text-zinc-500 dark:text-zinc-400 ml-2">(0-1)</span>
                  </Label>
                  <Input
                    id="debt_to_income"
                    type="number"
                    ...
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  />
                  {errors.debt_to_income && <p className="text-red-500 text-sm mt-1">{errors.debt_to_income.message}</p>}
                </div>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <Label htmlFor="savings_rate" className="text-base block mb-2">
                    <FinancialTermTooltip term="savings_rate">Savings Rate</FinancialTermTooltip>
                    <span className="text-sm text-zinc-500 dark:text-zinc-400 ml-2">(0-1)</span>
                  </Label>
                  <Input
                    id="savings_rate"
                    ...
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  />
                  {errors.savings_rate && <p className="text-red-500 text-sm mt-1">{errors.savings_rate.message}</p>}
                </div>
                
                <div className="space-y-3">
                  <Label htmlFor="insurance_coverage" className="text-base block mb-2">
                    Insurance Coverage (₹)
                  </Label>
                  <Input
                    ...
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  />
                  {errors.insurance_coverage && <p className="text-red-500 text-sm mt-1">{errors.insurance_coverage.message}</p>}
                </div>
              </div>
            </div>
            ...
            {/* Financial Concerns */}
            <div className="space-y-3">
              <Label className="text-base block mb-2">What are your primary financial concerns?</Label>
                  ...
                  <div key={concern} className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        setValue(
                          "financialConcerns",
                          checked ? [...current, concern] : current.filter((c: string) => c !== concern),
                        )
                      }}
                      className="border-teal-500 dark:border-teal-700 text-teal-600 dark:text-teal-400 focus:ring-teal-500 dark:focus:ring-teal-400"
                    />
              ...
              {errors.financialConcerns && <p className="text-red-500 text-sm">{errors.financialConcerns.message}</p>}
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                />
                {errors.existingDebts && <p className="text-red-500 text-sm">{errors.existingDebts.message}</p>}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select onValueChange={(val) => setValue("knowledgeLevel", val)} defaultValue={data.knowledgeLevel}>
                  <SelectTrigger
                    id="knowledgeLevel"
                    className="border-zinc-300 dark:border-zinc-700 focus:ring-teal-500 dark:focus:ring-teal-400"
                  >
                ...
                {errors.knowledgeLevel && <p className="text-red-500 text-sm">{errors.knowledgeLevel.message}</p>}
              </div>
